...
import { FaArrowLeft, FaEnvelope, FaUserCheck } from "react-icons/fa"
        ...
        <div className="relative z-10 text-white text-center max-w-md p-8">
          ...
          >
            ...
            <p className="text-red-100 mb-6">
              Verify your email to complete your registration and start using our platform.
            </p>
            <div className="flex justify-center">
              <FaUserCheck className="text-white opacity-20 h-32 w-32" />
            </div>
          </motion.div>
        </div>
      </motion.div>
